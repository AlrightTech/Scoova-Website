...
export default function SchoolImageGallery() {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-5 mt-8 lg:mt-0">
              ...
              <p className="font-normal leading-relaxed text-[14px] lg:text-[16px] text-[#2A2A2A] font-['Inter',sans-serif]">
                Showcase your school's facilities, events, and campus life with a beautiful image gallery. Upload, organize, and manage photos to give visitors a complete view of your school.
              </p>
            </div>
          </div>
        </div>
