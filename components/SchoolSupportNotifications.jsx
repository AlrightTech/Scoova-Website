...
export default function SchoolSupportNotifications() {
  return (
        ...
        <div className="rounded-[30px] p-4 mt-12 overflow-visible">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-start">
            ...
            <div className="relative lg:col-span-7 overflow-hidden lg:overflow-visible lg:min-h-[500px] min-h-[350px] sm:min-h-[400px]">
              {/* Image - schoolplan7.png */}
              <div className="relative w-full max-w-full lg:max-w-[672px] mx-auto lg:mx-0">
                <Image
                  src="/images/schoolplan7.png"
                  alt="System Support + Notifications"
                  width={672}
                  height={411}
            ...
            <div className="lg:col-span-5 mt-8 lg:mt-0">
              ...
              <p className="font-normal leading-relaxed text-[14px] lg:text-[16px] text-[#2A2A2A] font-['Inter',sans-serif]">
                Get dedicated support from our team and stay informed with real-time notifications. Receive alerts for new reviews, applications, and important updates to keep your school profile active and engaging.
              </p>
            </div>
          </div>
        </div>
