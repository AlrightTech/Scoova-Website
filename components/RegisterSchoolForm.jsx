    ...
    <>
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Add School Gallery</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Add School Management Team</h2>
            ...
            <button
              ...
              className="flex items-center gap-2 text-[#1E3A8A] font-medium hover:opacity-80 transition-opacity"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex justify-end gap-4 pt-8">
            <button
              type="button"
              className="px-6 py-3 text-gray-700 font-medium hover:opacity-80 transition-opacity"
            >
              Cancel
            </button>
            <button
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-8 relative">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-gray-600 text-base leading-relaxed">
              Once approved by the client, your<br />
              account credentials will be provided<br />
