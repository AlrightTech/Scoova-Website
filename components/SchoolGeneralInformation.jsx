...
export default function SchoolGeneralInformation() {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-5 mt-8 lg:mt-0">
              ...
              <p className="font-normal leading-relaxed text-[14px] lg:text-[16px] text-[#2A2A2A] font-['Inter',sans-serif]">
                Keep your school profile up-to-date with comprehensive information management. Update school details, contact information, and key statistics anytime.
              </p>
            </div>
          </div>
        </div>
